...
import { CheckSquare, Loader2, Mail, Lock, Eye, EyeOff, User } from 'lucide-react';
    ...
    <div className="min-h-screen w-full flex flex-col md:flex-row bg-background">
      ...
      <div className="hidden md:flex md:w-1/2 bg-zinc-950 dark:bg-zinc-900 flex-col justify-between p-12 text-white relative overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
          <div className="absolute top-[20%] left-[60%] w-[40%] h-[40%] rounded-full bg-cyan-500/20 blur-[100px]" />
          <div className="absolute bottom-[-10%] left-[-10%] w-[60%] h-[60%] rounded-full bg-indigo-500/20 blur-[120px]" />
        </div>

        <div className="relative z-10 flex items-center gap-3 font-bold text-2xl tracking-tight">
          <div className="h-10 w-10 rounded-xl bg-cyan-500 flex items-center justify-center text-white">
        ...
        <div className="relative z-10 max-w-md">
          ...
          >
            Start your journey to <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-indigo-400">peak productivity.</span>
          </motion.h1>
          <motion.div 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
